...
public interface IRBTree {
	/**
	 * Searches for a node with the specific key.
	 * If the key is not found the nearest node is returned.
	 *
	 * @param key
	 ...
	 *
	 * @param key
	 *            The original key of the node that will be changed/deleted
	 * @param newKey
	 *            The newKey which gets inserted
	 */
